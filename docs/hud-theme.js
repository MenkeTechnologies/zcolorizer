 ...
 * Storage keys live under the `zcolorizer-hud-*` namespace so the two projects
...
(function () {
  ...
  var STORAGE = {
    theme: 'zcolorizer-hud-theme',
    crt: 'zcolorizer-hud-crt',
    neon: 'zcolorizer-hud-neon',
    scheme: 'zcolorizer-hud-scheme',
  };
